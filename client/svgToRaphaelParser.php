 ...
 */
	class svgToRaphaelParser {
		...
		var $canvas = 'tulpasynth.canvas'; // Raphael canvas name
		var $group = '@all'; // Raphel set name
	...
	$parser = new svgToRaphaelParser();
	echo $parser->parse('Earth_recycle.svg', 'container', 'tulpasynth.canvas', '@all');
?>